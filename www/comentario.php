...
<div class="comments">
    <?php
    $query = "SELECT * FROM comentarios INNER JOIN usuarios ON comentarios.usuario_id = usuarios.id WHERE publicacion_id = " . $_GET['id']." AND estado='aprobado' ORDER BY fecha_comentario DESC";
